...
/**
 * A {@code WeakSetChangeListener} can be used, if an {@link ObservableSet}
 ...
 * @since JavaFX 2.1
 */
public final class WeakSetComplexChangeListener<E> implements SetComplexChangeListener<E>, WeakListener {

    private final WeakReference<SetComplexChangeListener<E>> ref;
     ...
     */
    public WeakSetComplexChangeListener(@NamedArg("listener") SetComplexChangeListener<E> listener) {
        if (listener == null) {
            throw new NullPointerException("Listener must be specified.");
        }
        this.ref = new WeakReference<SetComplexChangeListener<E>>(listener);
    }
    ...
    public void onChanged(Change<? extends E> change) {
        final SetComplexChangeListener<E> listener = ref.get();
        if (listener != null) {
